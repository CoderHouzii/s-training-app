...
public class SortAdapter extends BaseAdapter implements SectionIndexer{
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if (view == null) {
			...
			view = LayoutInflater.from(mContext).inflate(R.layout.item_sort_name, arg2,false);
        ...
        viewHolder.circleImageView.loadImageDefault(list.get(position).getUserInfo().avatar);
