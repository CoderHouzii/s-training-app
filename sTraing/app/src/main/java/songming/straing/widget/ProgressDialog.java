...
public class ProgressDialog extends Dialog{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        window.setLayout(UIHelper.dipToPx(getContext(),150f), UIHelper.dipToPx(getContext(),150f));
        window.setGravity(Gravity.CENTER);

    }

    public ProgressDialog setMsgText(String text) {
        msgTextView.setText(text);
        return this;
    }

    public ProgressDialog setMsgText(int resources) {
    ...
    public void dismiss() {
        try {
            ...
            KLog.e("error: progress dismiss " + e.toString());
        }
    }
